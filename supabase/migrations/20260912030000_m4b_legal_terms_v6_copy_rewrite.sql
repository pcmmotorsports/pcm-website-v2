...
--   PRIVACY_DOC.subtitle 多「聲明」兩字;LEGAL_LAST_UPDATED '2026-07-24' → '2026-09-12'(Sean Q2 甲 = 上線那天,
--   09-12 02:5x 定上線日 = 2026-09-12)。版本鍵 '2026-09-13' 與顯示日不同天是刻意的(見下一節)。
--   隱私三「站內搜尋紀錄、客服往來紀錄」(稿上「瀏覽歷程、客服往來對話紀錄」與實況不符,主視窗 09-12 裁照實況)。
--
-- ── 版本鍵為什麼是 '2026-09-13' ─────────────────────────────────────────────────
...
--     ⇒ 實際 hash = 57946fc4cf75e42f8f4c6491d6e1c24a12e942029ac3ac02f8516370dc5c2fcc
...
--        CURRENT_TERMS_CONTENT_HASH '294375cf…b713' → '57946fc4…2fcc'
...
--     order by version;
--   判準:
--     前:'2026-09-13' 整列缺席 ⇒ 正常路徑。後:該列出現、content_hash = 57946fc4…2fcc;其他列前後逐字相同。
...
BEGIN
  ...
  END IF;
  IF v_hash <> '57946fc4cf75e42f8f4c6491d6e1c24a12e942029ac3ac02f8516370dc5c2fcc' THEN
    RAISE EXCEPTION
