...
--
--    舊本體 md5 = 9b4a05f574acd499b949a59431bfba91  (35822 字元)
--    新本體 md5 = 3804f3463058df0062ac5ca34efcb2c9  (42865 字元)
--
...
BEGIN
  ...
  -- ⓪ forward-only:本檔已經貼過?
  IF v_md5 = '3804f3463058df0062ac5ca34efcb2c9' THEN
  ...
  IF v_md5 <> '9b4a05f574acd499b949a59431bfba91' THEN
    RAISE EXCEPTION '前置閘②:正式庫的函式本體 md5 是 %, 而我這一份是照 % 那一版改的。'
                    '🛑 中間有人動過它 ⇒ 貼下去會蓋掉那個改動。停下, 重新產生本檔。', v_md5, '9b4a05f574acd499b949a59431bfba91';
  END IF;
...
BEGIN
  ...
  IF v_md5 <> '3804f3463058df0062ac5ca34efcb2c9' THEN
    RAISE EXCEPTION '斷言①:貼完之後函式本體 md5 是 %, 期望 % ⇒ 進去的不是我這一份', v_md5, '3804f3463058df0062ac5ca34efcb2c9';
  END IF;
