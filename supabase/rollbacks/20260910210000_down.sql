...
--
-- 🔴🔴 **回捲鏈(2026-09-11 加):`20260911170000` 貼了之後, 要先跑 `20260911170000_down.sql`, 再跑本檔。**
--    那支把匯流點改成呼 `pcm_order_money_moved` ⇒ md5 不再是下面前置閘釘的 5cd27b50… ⇒ 本檔會正確地拒。
--    (拋棄式 PG 實測過:本支貼著時跑本檔 ⇒ 前置閘擋下;先回捲那支 ⇒ md5 回到 5cd27b50…)
--
