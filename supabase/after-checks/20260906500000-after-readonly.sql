...
-- ══════════════════════════════════════════════════════════════════════
-- 🔴🔴 **`\set ON_ERROR_STOP on` 是承重的, 不是禮貌**(2026-09-06 線【DB】拋棄式 PG 實測, 六窗同文):
--    `psql -f <檔>` 沒帶它 ⇒ **中途 ERROR 之後的每一句照跑, 而 rc 仍是 0**
--    ⇒ 📌 **我會把一份【殘缺的讀數】當成完整的讀數**, 而它印出來的每一格看起來都很正常。
--    🛑 我第一版寫了它, **重寫這支檔的時候弄丟了** —— 📌 **重寫會靜靜地丟掉上一版的防護。**
