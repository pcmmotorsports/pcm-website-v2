...
const APRILIA: SourceProductRow[] = [
  {
    supplier_slug: 'rpm', main_sku: 'APRILIA-01', sku: 'APRILIA-01-G-F', highlights_zh: null,
  ...
  {
    supplier_slug: 'rpm', main_sku: 'APRILIA-01', sku: 'APRILIA-01-M-F', highlights_zh: null,
    product_name: 'Front Fender', product_name_zh: '前土除',
    description: '碳纖維前土除,100% 手工。', category_zh: '土除', major_category_zh: '車殼外觀',
    vehicle_label: 'Aprilia RS660',
  ...
  {
    supplier_slug: 'rpm', main_sku: 'APRILIA-01', sku: 'APRILIA-01-T-G', highlights_zh: null,
...
const UNIV: SourceProductRow[] = [
  {
    supplier_slug: 'rpm', main_sku: 'UNIV-CARBON', sku: 'UNIV-CARBON-A', highlights_zh: null,
  ...
  {
    supplier_slug: 'rpm', main_sku: 'UNIV-CARBON', sku: 'UNIV-CARBON-B', highlights_zh: null,
    product_name: 'Bolt Kit', product_name_zh: '螺絲組',
    description: '通用碳纖維螺絲。', category_zh: '螺絲', major_category_zh: '周邊配件',
    vehicle_label: null,
    fitment_parsed: null,
...
describe('去碳:per-group / config 驅動(GB/Bonamici 形狀)', () => {
  const gbBase: SourceProductRow = {
    supplier_slug: 'gbracing', main_sku: 'GB-001', sku: 'GB-001', highlights_zh: null,
...
describe('W3(#267):variantImages 策略 — 非 RPM per-variant 直用、RPM 前綴過濾不變', () => {
  ...
  const boVariant: SourceProductRow = {
    supplier_slug: 'bonamici', main_sku: '0025', sku: '0025_BR', highlights_zh: null,
...
describe('A/#270 highlights 賣點條列', () => {
  const gbHl: SourceProductRow = {
    supplier_slug: 'gbracing', main_sku: 'GB-HL', sku: 'GB-HL', highlights_zh: ['6AL-4V G5 鈦合金,輕量耐腐蝕', 'DLC 黑鈦塗層'],
