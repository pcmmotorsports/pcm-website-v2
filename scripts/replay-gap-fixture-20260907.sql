-- 🔴🔴 這是【replay 失敗的補丁】, 不是 bootstrap;來源 = 正式庫唯讀 catalog 於 2026-09-07 06:02:20 CST
--    產生指令:bash scripts/replay-gap-fixture.sh <本檔> pcm_noncard_settle_recompute pcm_pending_refund_open_for pcm_pending_refund_amounts
