...
LINE_TIP="20260811080000"  # 2026-08-11 重釘 20260811030000->20260811060000(L5b-2 片 2a=P 窗;claim RPC DROP+重建、回傳三欄->四欄。**述詞一字未動**〔md5(split_part(prosrc,'RETURNING',1)) 兩版皆 f15644b5…〕⇒ 對 w5 各線被測面〔出貨/重算/摘要〕無交集;唯一連動是 l5b0-verify 的 claim 身分閘,已同批重釘);後續重釘 ->070000(D 翻種子收割)->080000(P 2c 收割;兩次皆主視窗收割時代釘,值已對、本註解 08-11 補齊)
