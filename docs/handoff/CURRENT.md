...
> | 題 | 端出 | 誰在等 | 狀態 |
> |---|---|---|---|
> | **Q-27a** `20260826140000`(客戶列表加生日兩欄)要不要現在 apply 到正式庫?甲=現在處理 / 乙=先不推。主視窗推薦**甲** | 08-27 主視窗 | 未推的 14 顆全部 | ⏳ 未回 |
> | **Q-27b** cf(資料庫探針)與 b4(板子稽核)兩窗今天開不開?甲=現在開 / 乙=今天不開。推薦**甲** | 08-27 主視窗 | 下手窗 `-de` 的兩條線今天沒有人 | ⏳ 未回 |
