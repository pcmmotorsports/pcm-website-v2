...
**不做:**
- 發票自動化(綠界 / 藍新 / 國稅局)— ✅ **A3 已拍(Sean 2026-09-13):手開紙本, 不串平台。**
  逐字:「我們目前是手開發票」+「手寫紙本發票(二聯/三聯式那種紙本)」;號碼與金額**開完回來補登記**。
  🔵 「以後要不要串」留著當未來的選項, **這一拍只結掉「階段 1 做不做」**。
  🔴 為什麼要把它結掉(2026-09-13 實例):這一格掛著「待拍板」, 而設計窗把它**讀成計畫中的現況**,
     在稿上寫出「發票在財政部平台開」那句錯的說明(11 個稿檔 + 說明檔一行, **產品碼零命中、沒上線**)。
     ⇒ 📌 **一個掛著「待拍板」的選項, 會被下一個人讀成「這是計畫中的」。**
- LINE 通知客人(階段 3)
...
- **待 Sean 拍板**:啟動前需拍 TapPay(sandbox 沿用 / 重申請)。⛔ ~~A3(發票自動化)~~ ⇒ **2026-09-13 已拍:手開紙本、不串平台**(見 :415)
...
|---|---|---|---|
| **A3** 發票自動化(綠界 / 藍新 / 國稅局) | M-3 | **已拍 ✅**(2026-09-13) | **手開紙本、不串平台**;號碼與金額開完回來補登記。以後要串是另一題 |
...
**M-3 啟動前必拍:** TapPay(⛔ ~~A3~~ ⇒ 2026-09-13 已拍:手開紙本、不串平台)
**M-6 啟動前必拍:** G2 + Vercel
