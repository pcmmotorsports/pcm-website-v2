...
- **狀態:** 🚧 施工中 —— **#306-a 取數層已完成**(2026-07-31、未 push、零 DB;見下方「#306-a 實測」),
  **#306-b 接線層(FilterSide / FilterDrawer 顯示 + 0 件灰掉)未做**。
  Sean 2026-07-31 補拍三題:**Q1=A 授權動正式資料查詢**(唯讀)/ **Q2=A 0 件灰掉且點不下去** /
...
- **#306-a 實測(2026-07-31、production build、本機打正式 Supabase、正式資料):**
  ...
  - **審查**:code-reviewer(opus)R1 **FAIL 7 must-fix + 11 nit,全數折入、駁回 0**。
