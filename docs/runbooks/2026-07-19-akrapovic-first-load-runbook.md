...
> 為什麼 matrix 留到最後:首灌若中途失敗、而排程已經包含它,**下一次排程**會在你還沒收拾完的狀態上再跑一次。
> (排程=台灣 12:30 表訂;2026-07-22 前為 03:00。⚠️ 若首灌發生在當日 12:30 之前,「下一次」就是**當天中午**、不是隔天;且 GitHub 排程可能延遲或整次丟棄、無延遲上限。)
