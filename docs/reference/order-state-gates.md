...
| `admin_compute_order_settlement` | **4** | 20260811030000_m4b_e10_op6a_compute_order_settlement.sql:50<br>20260812140000_m4b_lifecycle_refund_manual_reversal.sql:356<br>20260901030000_m4b_zero_total_settle.sql:1195<br>20260907170000_m4b_settlement_split_from_zero_total.sql:86 | `20260907170000_m4b_settlement_split_from_zero_total.sql:86` |
...
| `admin_record_manual_refund` | **4** | 20260820021000_m4b_e10_d1_record_manual_refund.sql:141<br>20260823020000_m4b_refund_notify_p2a_record_calls_sync.sql:290<br>20260905280000_m4b_cardcancel_p1_manual_refund_card_confirm.sql:89<br>20260909090000_m4b_cardalreadyrefunded_confirm_label.sql:166 | `20260909090000_m4b_cardalreadyrefunded_confirm_label.sql:166` |
...
| `admin_void_manual_refund` | **2** | 20260820100000_m4b_e10_d3b_void_manual_refund.sql:292<br>20260905440000_m4b_refundsync_p3_status_follows_ledger.sql:379 | `20260905440000_m4b_refundsync_p3_status_follows_ledger.sql:379` |
...
| `coupon_redeem_on_paid` | **2** | 20260901021000_m4b_coupon_p3b_create_order_redeem.sql:478<br>20260901030000_m4b_zero_total_settle.sql:467 | `20260901030000_m4b_zero_total_settle.sql:467` |
...
`:1046` SET payment_status = 'paid'::public.payment_status,

**允許集合(逐字)**

`:1018` IF v_order.cancelled_at IS NOT NULL THEN<br>`:1030` IF v_order.payment_status = 'paid'::public.payment_status THEN<br>`:1034` IF v_order.payment_status <> 'unpaid'::public.payment_status THEN<br>`:1046` SET payment_status = 'paid'::public.payment_status,<br>`:1051` AND payment_status = 'unpaid'::public.payment_status;
