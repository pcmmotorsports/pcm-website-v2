...
| `admin_mark_order_cancelled` | **3** | 20260902140000_m4b_mark_order_cancelled.sql:206<br>20260903093000_m4b_b4cancelkind_reject_reserved_reason.sql:604<br>20260905400000_m4b_cardcancel_mark_recompute_refunded.sql:98 | `20260905400000_m4b_cardcancel_mark_recompute_refunded.sql:98` |
...
`:350` SET cancelled_at            = pg_catalog.now(),

**允許集合(逐字)**

`:214` OR v_order.cancelled_at IS NULL<br>`:223` IF v_order.cancelled_at IS NOT NULL THEN
