...
| `pcm_noncard_settle_recompute` | **2** | 20260904230000_m4b_noncardpaid_settle_and_expire_leg.sql:170<br>20260905070000_m4b_pending_refund_on_late_payment.sql:308 | `20260905070000_m4b_pending_refund_on_late_payment.sql:308` |
...
| `pcm_pending_refund_on_cancel` | **3** | 20260901080000_m4b_autorefund_pending_refunds.sql:367<br>20260902030000_m4b_crossrail_pending_refund_net.sql:237<br>20260905070000_m4b_pending_refund_on_late_payment.sql:284 | `20260905070000_m4b_pending_refund_on_late_payment.sql:284` |
...
`:479` SET payment_status = v_new,

**允許集合(逐字)**

`:382` IF v_status NOT IN ('unpaid'::public.payment_status,<br>`:479` SET payment_status = v_new,<br>`:496` AND o.payment_status = v_status;   -- 🔴 樂觀鎖:狀態被別人改過就不寫
