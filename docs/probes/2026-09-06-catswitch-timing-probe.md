...
🟢 **修法**:**一發拿全部**(⛔ ~~全掃 211 ms 遠小於 3 秒~~ ⇒ 🔴 **訂正 2026-09-06 線 `front`:那個 211 ms 是【正式庫唯讀 psql】那一層量的;經過 app 的實測是 832 / 905 / 1004 ms**(preview `dpl_6gju1Bf89qU2fp3mueKPWZVXJQuv` 的 `[vehicleTaxonomy] cold n=12197 ms=`,三發)⇒ 🛑 **餘裕約 3 倍,不是 14 倍 ⇒ 不可以寫「逾時在數學上不可能」**),不分頁。**不動 `unstable_cache` 那一層。**
