...
⛔🔴 **2026-09-03 04:5x 全段作廢 —— 而推翻它的是我自己的測資**:
下面那個「斷崖在 1 ⇒ 2 詞」**是假象**。我的一詞樣本是 `rsv4`(**純 ASCII**),而兩詞/八詞樣本
**每一個都含中文** ⇒ 📌 **我以為我在變動「詞數」,而我同時變動了「有沒有中文」。**
✅ 拆開之後:**八個 ASCII 詞 654ms · 而【一個中文字】1,705ms** ⇒ **真正的變數是多位元組字元。**
⇒ **全文與後續(含「不要建索引」那個結論也一起撤)在 `2026-09-03-storefront-search-brand-plan.md` §9。**
⇒ **原文留著不刪** —— 它是那個推論錯在哪的證物。
