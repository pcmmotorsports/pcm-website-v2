...
## 🔴 **字面待統一 —— 在 Sean 回話之前,兩處都不准挑一個先寫下去**
主視窗 `-96` 2026-08-26 裁,逐字理由:
> **兩次都是他答的、兩次都是甲。我不會用「較新為準」把他前一次的字蓋掉 —— 那是文案,他親自拍的。**

⇒ **不是我挑,也不是主視窗挑。進下一批問 Sean。**
⇒ 🔴 **在他回之前,本檔與 `2026-08-16-customer-filters-four-fields-plan.md` 兩處都標「字面待統一」。**
   **實作時不得先寫死任何一組** —— 先寫下去的那一組會變成事實,而沒有人會回頭問。
...
3-3 🔴 **更正**(2026-08-26):~~既有客人有幾個 —— 沒查正式庫~~
    ⇒ **有一個數字,而它自己標【未確認】**:`2026-08-16-customer-filters-four-fields-plan.md:15`
      逐字「客戶總數 11、全部是自己測試用、有填生日 2 ⇒ 真實客戶 0」
    ⇒ **「沒有數字」與「有一個不能信的數字」是兩件事** ⇒ 開工前第一件事是【重量它】
    ⇒ 而若它是真的, `E=丙` 兩種篩法篩的是同一批 2 個人 ⇒ **成本問題要重提**

3-7 🔴 **性別那三個字用哪一組字面 —— ✅ 主視窗已裁:【端給 Sean】,兩處都標「字面待統一」**
    「不願透露」(08-16 `Q2=甲`)vs「不透露」(08-26 `Q11=甲`)—— 兩次都是他答的、兩次都是甲
    ⇒ **不用「較新為準」蓋掉他前一次的字** ⇒ 進下一批問他
    ⇒ **在他回之前不得先寫死任何一組**(見 §1-3b-①)。enum 是英文不受影響
