...
⑤ 未出貨 ⇒ 出貨日 = 列印當天（Asia/Taipei 曆面）
   🔴 測試注入固定 now；負向：把時區拿掉、用 UTC 曆面 ⇒ 在 UTC 15:xx 那個 now 上必紅
      ⚠️ 若測資的 now 挑在台北與 UTC 同一天，這格【恆綠】—— 必須挑跨日的那一刻
⑥ 三個號碼各自帶標籤，追蹤碼標明貨運商
...
· 出貨日跨日那格我【還沒寫】—— §6 ⑤ 那條「測資挑跨日時刻否則恆綠」是【預判】，
  要等真的寫出來才知道 vitest 的 TZ 設定會不會讓它失效
