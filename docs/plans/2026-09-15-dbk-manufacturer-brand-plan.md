# DBK 目錄裡的別家商品改掛製造商品牌(Q7 plan;§7 兩題已拍)
...
> - **範圍收窄(Sean 2026-09-16 01:0x 逐字「DBK 改掛品牌範圍：甲 只搬真的是該品牌做的」)**:報價單 5e 窗逐件表 ⇒
>   Brembo 38 列全是 DBK 配件、Akrapovic 1 列是配件、Öhlins 20 列只有 5 件自家 ⇒ **只搬 Termignoni 174 列 + Öhlins 5 件**;
>   其餘留 DBK。網站 `supplier-config` dbk `perRowBrand.allowedSlugs = termignoni / ohlins`;brembo 品牌頁仍 0 件商品。
>   ⚠️ 下面 §2 / §5 的 brembo 24、akrapovic 1、「187 件變便宜」等數字是收窄前的,未重算。
