 ...
 * 對齊 migration `20260604130000_m3_s2b1_create_order_rpc.sql` 簽名 L47-53 + return DTO L266-267。
 *
...
/** create_order RPC 入參(wire、對齊 p_lines / p_address_id / p_shipping_method / p_invoice)。 */
