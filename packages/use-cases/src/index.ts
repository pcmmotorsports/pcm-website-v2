...
// M-1-14e-2a:地址 CRUD use-cases(add / update / delete / set-default address;vehicle 鏡像留 e-2b)。
...
// ICustomerRepository(M-1-14d)、address 走 IAddressRepository(M-1-14d);concrete adapter 由 f 段 wire-up 注入。
