  ...
  return (
    <div className="pcard-gallery" style={{
      ...
      {showReal ? (
        ...
        //    ⇒ **品牌 logo + 底下一行小字**。🔵 **LOGO 那一半仍然成立, 沒有變。**
        //
        // 🔴🔴 **[2026-09-10 · 而那行小字的【字面】換了 —— Sean 拍甲]**
        //    ⛔ ~~「暫無照片」~~ ⇒ ✅ **「商品圖片準備中」**。逐字:`甲 = 都說「商品圖片準備中」`。
        //    🔬 **為什麼要統一**:走查 2026-09-10 正式站實見 —— 同一件商品,
        //      **卡片說「暫無照片」, 點進商品頁說「商品圖片準備中」** ⇒ 719 件, 每點一次換一句話。
        //    🎯 **而它不是「兩個字串不一致」, 是【一個字串】對上【一張圖】** ——
        //      商品頁那句**燒在 `public/placeholder-product.png` 裡**(PCM logo + 橘線 + 那六個字)
        //      ⇒ 📌 `git grep` 永遠找不到它。⇒ **所以動的是這一行, 不是那張圖。**
        //    ⚠️🛑 **而我們端他的時候寫過這句話可能兌現不了, 逐字留著**:
        //      那 719 件多半是**供應商自己就沒圖**(`extreme-components.com/…/noimage.jpg`),
        //      照片**可能永遠不會來** ⇒「準備中」是一個我們兌現不了的承諾。
        //      ✅ **他看過這一句, 仍然拍甲。理由他沒說 —— 不要替他補一個。**
        //      ⇒ 🎯 **留這一段的理由:下一個人才不會以為「沒有人想過這件事」。**
        //    字體規格照 design 的 `.ph`
