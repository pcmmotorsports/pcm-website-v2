...
describe('BrandPageCategories · 前提(資料形狀)', () => {
  it('🔴 58 筆 / 14 種名稱 / 每家 1-7 個 / colorIndex 值域 0-11 缺 2', () => {
    ...
    // 4 → 5(2026-09-15 夜):brembo「煞車系統」配 0,與 EBC 同名同色。
    expect(all.filter(([, i]) => i === 0)).toHaveLength(5);
