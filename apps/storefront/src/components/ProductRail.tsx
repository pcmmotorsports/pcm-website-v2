...
//
// 🔴 **`ed-select-empty` 這個 class 在 storefront 的 CSS 裡【沒有任何規則】, 而【沒有人看過它】。**
//    2026-08-30 線G 開真瀏覽器分了那 14 個「死 class」——14 個裡我實測 7 個(全是假警報),
//    而這一個【走不到】:要讓這個軌道進入 error 或 empty 狀態（本檔 `:221`） ⇒ 標【未驗】。
//
...
// ⚠️ 而讀碼看到它【帶 inline `style={STATE_STYLE}`】⇒ 很可能是「根本不需要 CSS 規則」那一種,
//    而那是【讀來的、沒有量到】—— 開到畫面的人請順手確認這一句。
//
