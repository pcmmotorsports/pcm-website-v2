...
//
// MotogadgetShowcase smoke test — 品牌放量 N°01 + N°02(#212 方向3)。eyebrow=文字 lockup(無 logo 檔)。
...
describe('MotogadgetShowcase', () => {
  it('N°01:eyebrow 文字 lockup + h2 + lead + 3 卡', () => {
    ...
    expect(lockup?.textContent).toBe('motogadget'); // 無 logo 檔 → 文字 lockup(補圖清單)
