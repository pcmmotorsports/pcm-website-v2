...
// 🔴 **上面那一行是 2026-08-21 的讀數, 今天不成立** —— 那六家裡 dna / gilles / rizoma / dbk / wrs
//   都已經有 case(wrs 2026-09-04)⇒ **只剩 kineo**。原句留著(它是那天的起因紀錄), 而補這一行是因為:
//   📌 **一句寫著「6 家沒有」的句子, 不會因為那六家陸續補上而自己變色, 而讀的人預設它是現況。**
