...
const SLIDES = [
  ...
  // 🛑 **`代理品牌` 這四個字【決定不改】—— Sean 2026-09-09 夜拍乙:設計稿優先。**
  //   2026-09-09 手機走查時提出:它與站上自己那句留餘地的字面互相矛盾
  //   (`HomeStatement.tsx:80` 逐字「全站皆為原廠正品,**部分**品牌正式代理、部分平行輸入」)
  //   ⇒ 一個講「部分」、一個把整面品牌牆概括成「代理品牌」。
  //   ⇒ 而它是 OD 設計稿的字面(鐵則 1)⇒ Sean 判**設計稿優先,不改**。
  //   📌 寫在這裡是為了**下一個人不用再撿一次** —— 這不是沒人看到,是看到了而且拍過了。
