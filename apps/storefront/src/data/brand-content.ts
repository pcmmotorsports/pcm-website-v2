...
export const BRAND_CONTENT: BrandContent[] = [
  ...
  },
  {
    ...
    "country": "義大利",
    "origin": "義大利 · 米蘭",
    "lede": "由 Mirco Sapio 於米蘭創立的機車配件廠，產品涵蓋風鏡、儀表護蓋、定風翼與大燈罩；碳纖維、CNC 鋁、工業級 3D 列印與射出成型四種製程並用。",
    "wallTagline": "風鏡、車身飾板",
    ...
    "about": {
      "lead": "<strong>從構思、繪圖、成型到成品，全程同一個人跟進。</strong>創辦人 Mirco Sapio 自述：對機車一直有特別的熱情；與多間機車設計工作室合作多年後，想把累積的能力收攏成自己的產品概念，這就是 MATERYA。<br><br>品牌的宣言只有一句：<strong>設計我自己想騎的東西。</strong>",
      "pull": "這個規模做不了大量，但細節不會在交接時被稀釋。",
      "tail": "<strong>碳纖維、CNC 鋁、工業級 3D 列印與射出成型，四種製程並行。</strong>風鏡、儀表護蓋與定風翼的需求本就不同，以單一製程涵蓋，必然犧牲其中一項。<br><br><strong>風鏡是少數同時影響外觀與體感的零件。</strong>高度差兩公分，長途的體感就不同：過低則風壓直接作用於胸口，過高則可能在安全帽的高度形成亂流。型錄把車型與年式分開編排。歡迎提供您的車型年份與常行駛的路段，由我們替您挑高度。"
    },
    "aside": {
    ...
    "highlights": {
      ...
      "cards": [
        ...
        {
          "t": "端到端一個人完成",
          "d": "從<strong>構思、繪圖、成型到成品全程親自跟進</strong>。官網把流程寫成四步：想 → 畫 → 打樣 → 製造。品牌的定位是回應具體需求，而非鋪一條廣泛的產品線。"
        },
        {
          "t": "四種製程並行",
          "d": "<strong>碳纖維以高壓釜成型、CNC 鋁、工業級 3D 列印用 PA12 / PA11 尼龍，再加上射出成型</strong>，四種同時使用。風鏡、儀表護蓋與定風翼的需求本就不同，以單一製程涵蓋必然犧牲其中一項。"
        },
        {
          "t": "按車型與年式分開",
          "d": "型錄把車型「與年式」分開編排，MT-09 MY21 與 MY24 不是同一件。風鏡的固定點與導流角度會隨年式改版而變。官網目前列出 BMW / DUCATI / KTM / SUZUKI / TRIUMPH / YAMAHA 六家車廠的專用件。"
        }
      ]
    },
    "craft": {
