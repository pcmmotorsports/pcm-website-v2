...
export const BRAND_CONTENT: BrandContent[] = [
  ...
  },
  {
    ...
    "about": {
      "lead": "<strong>從構思、繪圖、成型到成品，全程由同一人執行。</strong>創辦人 Mirco Sapio 自述，他對機車始終抱有特別的熱情；長年與多間機車設計工作室合作之後，將累積的設計能力整合為自有產品線，即 MATERYA。<br><br>品牌宣言只有一句：<strong>設計我自己也想騎的車。</strong>",
    ...
    "highlights": {
      "title": "為什麼是 MATERYA",
      "lead": "從構思、繪圖、成型到成品，全程由同一人負責。這樣的規模無法量產，但細節不會在分工交接之間流失。",
      "cards": [
        {
          "t": "設計工作室出身",
        ...
        {
          "t": "端到端一個人完成",
          "d": "從<strong>構思、繪圖、成型到成品全程親自執行</strong>。官網將流程歸納為四個階段：構思 → 設計 → 打樣 → 製造。品牌定位在回應具體需求，而非鋪設廣泛的產品線。"
        },
        {
          "t": "四種製程並行",
