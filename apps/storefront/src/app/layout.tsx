...
import '../styles/order-detail.css'; // 訂單明細頁(/account/orders/<id>);獨立一支的理由見該檔檔頭(account.css 那道 media 順序守門)
...
export const metadata: Metadata = {
  ...
  // 🔴🔴 **⛔ ~~「代理 Akrapovič、Rizoma、CNC Racing 等品牌」~~ —— 那句【替三個品牌做了身分宣稱】。**
  //   Sean 2026-09-09 拍乙逐字:「**不是總代理,是經銷**」;而站上自己的字面是刻意留餘地的
  //   (`components/HomeStatement.tsx:80` 逐字:「全站皆為原廠正品,**部分品牌正式代理、
  //   部分平行輸入**,杜絕仿品風險。」)⇒ 我原本那句把「部分」寫成了指名三家。
  //   🛑 **那不是文案語氣問題,是事實宣稱** —— 寫錯品牌方可以投訴,而且**沒有人會發現**
  //     (Google 不會叫、測試不會叫)。⇒ 改成抄站上那句既有的字面,不自己升級用詞。
  //   🔴 守門在 `lib/llms-txt.test.ts`:掃本檔字面,不得出現「總代理 / 獨家代理 / Exclusive Distributor」那組。
  // 🔴🔴 **⛔ ~~「專營歐系與日系重機改裝部品」~~ —— 那半句是【假的】,而它上線過(2026-09-10 抓到)。**
  //   實查 `data/brand-content.ts` 的 21 家:義大利 9 · 英國 5 · **泰國 2** ·
  //   西班牙 / 盧森堡 / 斯洛維尼亞 / 德國 / 希臘 各 1 ⇒ **日本 0 家、而且有兩家泰國的。**
  //   ⇒ 「日系」無中生有,「歐系」也蓋不住泰國那兩家。
