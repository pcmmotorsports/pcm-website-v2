...
import { fetchFeaturedProducts, tryVehicleTaxonomy, fetchCategories } from '@/lib/products';
...
export default async function HomePage({
  ...
  const [tier, featured, vehicleTax, categories, garage, brandsWithProducts] = await Promise.all([
    tierPromise,
