    ...
    <fieldset className='space-y-2 rounded-md border p-3' data-testid='manual-order-lines'>
      ...
      */}
      ...
      <p className='text-sm font-medium text-amber-700 dark:text-amber-500'>
        ...
        {/* 🔴🔴 **[2026-09-10] 補上中間那一句 —— 而補它的理由是【我自己讓這句話變得不完整的】。**
            ⛔ ~~原本兩句:「請填未稅…稅由系統自己算, 不要自己加上去;填成含稅會多課一次稅。」~~
            🔬 那兩句在 `⟦b4-INVOICE5PCT⟧` 之前是完整的:含稅那條路**根本走不通**(除不盡就退件)。
            ✅ 而今天它走得通了 —— 把右邊那格切成「含稅」+ 勾發票 ⇒ 走殘差 ⇒ 總額湊回他打的數。
            ⇒ 📌 **那兩句話因此【擋住了一條現在會動的路】** —— 它們沒有錯, 它們**不完整**。
            🎯 **而這一格的形狀值得記**:一次好的改動, 讓畫面上一句【給員工看的話】變得不完整,
              而**沒有任何東西會紅** —— 那句話當時沒有任何一格測試在守它(見本檔的測試)。
            🛑 **而那句警告【不刪】** —— 它描述的是「**不切下拉**」那條路, 今天仍然為真
              (下拉留在預設「未稅」而打含稅數字 + 勾發票 ⇒ 真的多課 5%)。
            📌 三句話三個動作:**預設怎麼做 · 例外怎麼做 · 做錯會怎樣。** */}
        <strong>單價這一格</strong>請填<strong>未稅</strong>金額 —— 經銷價單上多少就填多少。
        稅由系統自己算,不要自己加上去。
        <br />
        🔵 手上只有含稅價?把右邊那格切成<strong>含稅</strong>,系統會自己換算回未稅。
        <br />
        🛑 而<strong>不切</strong>就直接填含稅數字 ⇒ 勾了開發票會多課一次稅。
      </p>
