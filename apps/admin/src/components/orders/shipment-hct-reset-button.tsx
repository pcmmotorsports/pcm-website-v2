...
// 🔴🔴 **2026-09-18 訂正:那句話今天是假的, 而它的效果是【把人推去手動改庫】。**
//    🔬 `supabase/APPLIED.tsv` ⇒ `20260905320000` **貼於 2026-09-05**。
//    ✅ **現在的事實:那顆鈕【可以按】** —— 而且它正是卡在「送出結果未知」時
//       `docs/runbooks/hct-unknown-stuck-manual-reset.md` 要人按的那一顆。
//    🛑 **所以不要繞過它去手動改庫** —— 手動改庫繞掉的是上面那段「要打字 + 寫進稽核」,
//       而那一段的存在理由是「客人可能收到兩箱」這個代價要有人負責。
//    📌 **舊字面留著不刪**:它當時是對的(這一片確實不得先於那支板上線),
//       過期的只有「還沒貼」那三個字。
