...
export const MANUAL_SMALL_BUTTON =
  'border-border bg-card inline-flex shrink-0 items-center rounded-[7px] border px-2 py-[2px] text-xs leading-[1.4] whitespace-nowrap text-(--fg-2) disabled:opacity-50';
