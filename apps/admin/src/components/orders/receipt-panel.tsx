...
export function ReceiptPanel({
  ...
  return (
          <div className='rounded-md border p-3'>
            ...
            {/* 🔴 `#476` 片4 改了下面那句的字面:原本寫「這個品項**還沒有任何採購紀錄**」,
                而本片讓「貨到了」選單排除作廢的採購 ⇒ 一個「採購全部被作廢」的品項也會走到這裡,
                它**有**紀錄、只是都撤了 ⇒ 原字面對那種情況是謊話。
                (關卡 code-reviewer 抓到;這正是 `#476` 條目描述的病灶形狀
                 「畫面說的跟事實對不上、沒有一行字解釋」**在新地方復發**。)
                ⚠️ **刻意不分兩態**:兩種情況員工的下一步完全相同(去採購區塊登記來源),
                而要分辨它們得讓這支 DTO 多帶一個「被濾掉幾筆」的欄位 —— 為一句措辭多一條資料流,
                不划算。改成**不宣稱原因**即可誠實。
                🔴 也不能靠「片3 的採購表已經說過了」—— **那張表不在這個畫面上**
                (本面板掛在出貨對話框)。 */}
