            ...
            {first ? (
              <td className={`${TD} ${CELL.date} text-muted-foreground text-xs`} data-l='下單'>
                ...
                {/* #350c:桌機開右側面板(`/orders?…&panel=<id>`)、手機走整頁 `/orders/[id]`。
                    ...
                    🏁 **2026-09-23 起這段只適用於「其餘品項」那一列**:單號那一格的雙份連結已經
                       合成一顆(永遠指明細頁), 展開 / 收合改掛箭頭 —— 見下面那段。
