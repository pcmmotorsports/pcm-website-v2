...
// ✅ **[2026-09-01 回填 · 線【帳號】`-7a`]** 那一條**確實落地了** ⇒ **backlog `#671`**
//    (標題逐字「片1c 的收合守門走的是**字面掃描**,而要守的是**行為** —— 乙案的缺口」)。
// 🔴 **為什麼要補這一行**:原句只寫「已立 backlog」而**沒有號** ⇒ 下一個人查不到它有沒有真的被接走,
//    只能【相信】它。而有號就【查得到】。⇒ 同族全文在板上 `⟦5b-REPORTEDNOTLANDED1⟧`。
