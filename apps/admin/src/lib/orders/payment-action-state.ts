...
const FAILURE_MESSAGES: Record<PaymentFailureCode, string> = {
  isolation: '系統設定異常，這筆收款未登記。請聯絡系統管理員處理，勿重複送出。',
  actor_invalid: '目前的操作人身分無效或已停用，這筆收款未登記。請重新登入；若仍無法操作，請聯絡系統管理員。',
  received_at_out_of_range:
    '收款時間不可早於訂單成立時間，也不可晚於現在。請修正日期。',
  ...
  //    要強調就把重點寫進句子結構,不要靠記號。
  row_count:
    '系統異常，本次收款未登記。請勿重複送出，並聯絡系統管理員協助確認。',
  ...
  rejected:
    '目前訂單不允許登記收款，或表單內容不正確。' +
    '上次送出的款項可能已登記成功，請先核對收款紀錄；' +
    '確認尚未登記後，才重新整理頁面，核對訂單狀態並再次送出。',
  forbidden: '你沒有執行此操作的權限，這筆收款未登記。請聯絡系統管理員確認權限。',
  ...
  content_conflict:
    '這筆收款先前已登記成功，但本次送出的內容與原紀錄不同。' +
    '請核對收款紀錄；如需更正，請先沖銷原紀錄，再重新登記。請勿修改目前表單後再次送出。',
  ...
  error:
    '尚未確認收款是否登記成功，請先核對收款紀錄。' +
    '若已有這筆款項，請勿再次送出；確認尚未登記後，才在目前表單再次送出。' +
    '確認前請勿重新整理頁面，以免再次送出時重複登記收款。',
};
