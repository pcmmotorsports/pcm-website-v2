...
export const SUPPLIER_RESULT_MESSAGES = {
  ...
  duplicate: {
    // 🔴 2026-09-16 Q6 甲:啟用 / 停用只有管理者能做 ⇒ 「按該列的啟用」改成請管理者按(一般員工照舊文案去按會被 denied)。
    text: '這個名稱已經有了,沒有新增。到下方清單找出那一家;若它顯示為「已停用」,請管理者按該列的「啟用」即可繼續使用。',
    tone: 'warn',
  },
  ...
  denied: {
    // 🔴 2026-09-16 Q6 甲:改名、啟用 / 停用限管理者(新增任何員工都行)⇒ 權限那一半要講得出「哪些事只有管理者能做」。
    text: '沒有權限,或登入過期了。未儲存。供應商改名、啟用 / 停用只有管理者能做(新增任何員工都可以);你是管理者的話,先重新登入再試一次。',
    tone: 'error',
  },
