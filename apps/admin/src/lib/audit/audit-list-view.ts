...
export const AUDIT_ACTION_LABEL: Record<string, string> = {
  ...
  //    🔵 **而這一次刻意【不加】那道守門,判準寫在這裡給下一個人**(主視窗 2026-09-13 裁):
  //      加守門解的是「下一個人會不會記得讀這段註解」,那是**下一次**的問題,而它今天沒有發生
  //      —— 這次是靠讀註解補上的。
  //      🔴 **判準是「第三次」**:如果你是因為漏了這張表而讀到這一行,**你就是第三次**
  //      (前兩次:`20260912040000` 那片 Fable 審抓到、本次貼板 138 自己回頭補)。
  //      ⇒ 那時它就不是「下一次的問題」而是**一個反覆的坑**,加分母守門的理由才是量出來的。
  //      📌 兩張並排的字典,一張有分母守門、一張沒有 —— **漏的永遠是沒守門的那一張。**
