...
//
// ⚠️ **2026-09-06 訂正:下面這個標題的受詞搬家了**(code-reviewer nit)——
//    那兩支現在住在 `@pcm/pdf`(`packages/pdf/src/index.ts`), 而**後台已經可以 import 它**
//    (⟦f3-SHIPPDF1⟧ P-1)。⇒ 🔴 **而下面那段【為什麼不照抄】的理由要自己重讀一次** ——
//    它當時的前提是「那段碼綁在顧客站裡」, 而那個前提已經不成立。
//    🛑 我**不在本片改那個決定** —— 後台要不要走同一條是 P-2 的事。
