...
const ACTOR_SOURCE_COPY: Readonly<Record<CopyKey, string>> = {
  ...
  'ticket-unresolved':
    '。目前無法確認你的員工身分，可能是帳號已停用、不在名單中，或名單載入失敗。需要記錄操作人的功能暫時無法使用。請重新整理；若仍無法使用，請聯絡管理員。',
  ...
  'self-selected-unset':
    '。請先在下方選擇操作人，再使用修改訂單、登記收款等需要記錄操作人的功能。',
  'self-selected':
    '。操作紀錄會使用你選擇的身分，但系統尚未驗證是否為本人。目前只驗證登入資格；須待報價單系統建立並串接個人帳號後，才能驗證操作人的身分。',
  ...
  none: '。目前使用共用密碼或首次建置方式登入，無法確認操作人。下方選單不會生效，修改訂單、登記收款等功能也無法使用。請改用個人帳號登入。',
  ...
  'stale-ticket':
    '。目前的登入資料尚未包含個人身分，下方選單不會生效，修改訂單、登記收款等功能暫時無法使用。請先不要登出。請管理員確認報價單系統已完成個人帳號串接，再登出並重新登入。',
};
        ...
        {deadLetter.unreadableReason !== null ? (
          ...
          <>
            ...
            <p className='text-muted-foreground mt-1 text-xs'>
              重排後，「已放棄」會減少一封；「還沒寄出」的總數要等郵件寄送成功後才會減少。
            </p>
            <p className='text-muted-foreground mt-1 text-xs'>
              清單可能包含尚未處理的舊郵件，仍需人工處理，數量不會自動歸零。
            </p>
          </>
        )}
