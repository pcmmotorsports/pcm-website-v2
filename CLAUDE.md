...
| 開新施工窗/新 session 主視窗建置/工作流移植他專案 | `docs/runbooks/multi-window-command-workflow.md`(2026-08-09 Sean 拍板常設;§B 主視窗/§C 施工窗啟動提示詞/🔴 **§C-3 報交界的四格**:哪支・加法還是改法・有沒有動簽名・做完會不會再回來 —— 動到跟別條線有交集的檔【之前】讀它,那是「不用問就能開工」與「要先協調」的判別法) |
