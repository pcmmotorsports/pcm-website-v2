...
**🆕 M-3 階段②-② adapter+use-case 地基 ✅**(pg 已批 A1=A、BLOCKER+3MUST-FIX+8SHOULD 全落實);**②-③ 前 Sean 1 件**:確認 `PAYMENT_CONFIRMER_DB_URL`=直連 5432(非 6543 pooler、見 Blocker);其餘無新待決策。前序:②-① ✅ 上 prod。
