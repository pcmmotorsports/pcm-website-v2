...
## 下一步
①Sean 照 `docs/specs/2026-08-12-order-admin-acceptance-package.md` 跑訂單後台總驗收(🔴 六項優先;已推版、`REFUND_UI_ENABLED=1` 已設)。②Sean 看 OD 第四輪成果並拍狀態配色 A/B/C(OD 推薦 B)+ 密度預設檔 + 「未收未定」第五值。③**2f apply 停點**:主視窗先對 Sean 講四條(`lock_timeout` 逾時是無名失敗 / TapPay 是唯一超退防線且 partial 不查帳 / 回退必須直連 5432 且**無負測**、Supavisor 特例未確認 / 行為證據全產自 macOS·PG 17.10 而正式庫是 Linux·17.6),講完才打勾、才排 apply。④D/P 開新視窗接續:D 片 2 採購撤銷 plan(高風險;🔴 開工第一動=重數 DB 面,派工單那句 `grep`=0 只證「沒有這個名字的 RPC」)、片 3 欄位精簡等 OD 定案。⑤#409 08-13 import 後三句 SQL 驗 0 結案。⑥2g→超退閘 #445→④-a/U1-U3 解鎖(S/E 屆時開新窗)。
## Sean 待決策
🔴 **2f apply 停點四條**(主視窗要先講,講完才排 apply)。徽章兩題:#446 沖銷之沖銷語意(D 立案三選項)/ #437 訂單標頭殘題(要不要標頭再一顆「已收足」徽章;四點主體已完工 `76aff2e3`)/ 採購「改軟」三片做完後要不要接 #374 採購單層與庫存(落點已定=報價單 repo)/ memory 索引下輪盤整再議。~~視覺統一改輪~~(2026-08-13 已拍:OD 三塊方向選定,詳情甲/列表丙/客人卡甲)。~~OD 三題~~(2026-08-13 已拍:狀態配色 **A 溫和**(推翻 OD 推薦的 B)/ 密度預設 **寬鬆 40px** / 「未收未定」第五值 **保留**;第五輪只修兩件=物品名稱吃空白其餘六欄被截、手機版排列)。
## Blocker
