...
**當前 slice:** **M-1-16b-3 ✅(全量灌 933 商品 + 7277 變體、抽驗 PASS、PCM 自驅、計時例外、待 Sean 肉眼驗)**(M-1-16b 三片第三片〔16b-1 seed✅→16b-2 腳本✅→16b-3 全量灌〕、**M-1-16 RPM Carbon 主體上架完成**。Sean go 開跑 `pnpm dlx tsx scripts/rpm-import.ts`〔無 dry-run〕全量寫線上目標 DB:分群 933 群〔=預期〕、products 933/933 + product_variants 7277/7277 upsert。MCP 唯讀抽驗全綠:筆數 933+7277 ✅ / orphan_products 0 + orphan_variants 0〔FK 全中〕/ null price 0〔商品+變體價全有〕/ distinct brand 1〔RPM CARBON〕+ cat 1〔碳纖維部品〕/ no_title 0。🔴 經銷價紅線守住:`products_public` + `product_variants_public` 皆**不含 price_store 欄**、933+7277 全 has price_general。抽樣 RPM-APRILIA-01:title 車台護蓋〔中文〕/ subtitle Aprilia RSV4·碳纖維 / price_general 14600〔群最低、=price_by_tier.general〕/ availability in-stock / fitments 8〔聯集去重〕/ images 1〔商品代表圖〕/ 8 變體 / G-F 變體 5 張專屬圖〔檔名過濾〕+ spec{weave:Forged,finish:Glossy}。**待 Sean 肉眼驗**〔首頁精選自動顯真 RPM 商品 / 逛商品 / 中文標題 / 變體規格選擇器〔16c 才接、現詳情頁仍 mock〕/ 價格 / 車款〕。**16b-3 無 code commit**〔純執行腳本 + 抽驗、腳本已 16b-2 commit〕、本 STATUS commit 記錄里程。**16c = 前台接真變體**〔詳情頁 findByHandle + mapVariantRow、backlog #203〕、**16d = 每週重抓同步**〔留〕。前序 16b-2〔匯入腳本〕詳述見 git history。)

**Branch:** dev

## 最後更新
2026-06-01 — Claude Code [M-1-16b-3 ✅(全量灌 933 商品 + 7277 變體進線上 DB、M-1-16 RPM Carbon 主體上架完成;Sean go 開跑 tsx rpm-import 無 dry-run;MCP 抽驗全綠:933+7277 / orphan 0 / null price 0 / brand·cat 各 1 / 🔴 兩 public view 無 price_store / 抽樣 APRILIA-01 title 車台護蓋·price 14600·G-F 5 張專屬圖;待 Sean 肉眼驗〔首頁顯真商品〕;16b-3 純執行無 code commit、本 STATUS commit 記里程;16c 接真變體 / 16d 週同步留;未跑 busboy-end、STATUS 手動更新)]

## 最近 3 commit
> 下表列近期 3 個有意義的可達 commit(挑有意義的、非機械 git log -3;本 M-1-16b-3 STATUS commit〔HEAD〕記可達祖先 bbcd8bc 為表頂、本 commit 自身 hash 不入表〔避 busboy 雙 amend orphan、見 memory project_status-top-hash-off-by-one-normal + backlog #180〕;本片未跑 busboy-end、STATUS 手動更新)
| Hash | 訊息 | 時間 |
|---|---|---|
...
## 下一步
**M-1-16b-3 ✅(全量灌完成、M-1-16 主體上架、未 push STATUS commit)→ Sean 肉眼驗 + 16c/16d**:下一步 = **Sean 肉眼驗**〔首頁精選自動顯真 RPM 商品〔fetchFeatured→listByCategory 已通、catalog 0→933 自動冒、不需改 code〕、中文標題「車台護蓋」等、價格「NT$X 起」、車款〕。**16c = 前台接真變體**〔詳情頁 findByHandle + adapter embed product_variants_public + mapVariantRow + ProductInfo 吃真 variants 規格選擇器、backlog #203;**詳情頁/list 頁現仍 mock**、list 頁另排 Q4=A〕。**16d = 每週重抓同步**〔讀來源最新 → upsert、看 last_synced_at;fitment 終局 re-parse 後再同步〕。g-7 wallet HOLD #202 不變。
