...
## 下一步
**g-6a ✅(唯讀愛車列表、未 push)→ g-6b**:愛車 tab 唯讀列表已建〔composition getVehicleRepo + page listByCustomer + AccountView vehicles prop + .acc-bike 卡 + 空狀態〕。**下一片 = g-6b**〔愛車新增表單:新 InlineVehicleForm〔搬 design L760-798、純文字欄 name/year/engine/km/mods/service + 設主車勾選、無發票三 tab〕+ 新 app/account/vehicle/actions.ts addVehicleAction〔鏡像 addAddressAction 信任邊界、VehicleInput safeParse、無巢狀 invoice〕、鏡像 g-5b、session-write 跑 codex 關卡2〕→ g-6c〔愛車編輯/刪除 + 設主車靠編輯表單勾選 swap、鏡像 g-5c〕→ g-7〔wallet 接 getBalance/listEntries〕。**g-6a 卡片視覺肉眼驗留 g-6b**(Sean 拍:g-6a 只驗空狀態+tab 渲染夠、卡片視覺等 g-6b 能自己加車一起驗;空狀態+tab 渲染沿用 g-5a 已驗 .acc-empty pattern)。**g-5a/g-5b/g-5c 肉眼驗 ✅**(2026-05-31 Sean 實機驗 address CRUD 過)。
